// ============================================
// EMAILJS CONFIG
// Uzupełnij po rejestracji na emailjs.com:
// 1. Zarejestruj się na https://www.emailjs.com
// 2. Dodaj Email Service (Gmail/Outlook)
// 3. Stwórz template zamówienia
// 4. Wklej swoje klucze poniżej
// ============================================
const EMAILJS_PUBLIC_KEY  = 'TWOJ_PUBLIC_KEY';   // Account > API Keys
const EMAILJS_SERVICE_ID  = 'TWOJ_SERVICE_ID';   // Email Services
const EMAILJS_TEMPLATE_ORDER = 'TWOJ_TEMPLATE_ID'; // Email Templates
